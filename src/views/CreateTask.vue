<template>
  ...
  <div v-else class="col-12 sm:col-10 md:col-8  xl:col-6 mx-auto mb-8 px-4">
    <TaskHeader/>
...
import TaskHeader from "@/components/createtask/TaskHeader.vue";
import TaskDescription from "@/components/createtask/TaskDescription.vue";
import TaskLocation from "@/components/createtask/TaskLocation.vue";
import TaskExpireTime from "@/components/createtask/TaskExpireTime.vue";
import TaskGroupAndExecutor from "@/components/createtask/TaskGroupAndExecutor.vue";
import TaskImages from "@/components/createtask/TaskImages.vue";

export default {
  name: "CreateTask",
  components: {TaskImages, TaskGroupAndExecutor, TaskExpireTime, TaskLocation, TaskDescription, TaskHeader},
  setup() {
