...
export const createTask = {
    ...
    actions: {
        getRelatedGroups({commit}) {
            return Get.getRelatedGroups().then(
                value => {
        ...
        getRelatedExecutorUsers({commit}, group) {
            return Get.getRelatedExecutorUsers(group.id).then(
                value => {
        ...
        creatTask({state}) {
            return Post.createTask(state.description, state.expireDatetime, state.location?.lat, state.location?.lng,
